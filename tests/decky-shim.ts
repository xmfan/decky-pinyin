...
export const SliderField = ({label,value,min,max,step,onChange,disabled}: any) => h("label", {}, label,h("input",{type:"range",value,min,max,step,disabled,onChange:(e:any)=>onChange(Number(e.target.value))}));
