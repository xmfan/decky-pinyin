...
class Plugin:
    async def _main(self):
        ...
        self.state = {"status": "stopped", "message": "Ready", "result": None, "screenshot": None, "busy": False}
    ...
    async def start(self):
        async with self.lock:
            ...
            try:
                ...
                self.input_status = ("L4 connected · hold 1 second to capture; hold 0.5 seconds to dismiss"
                                     if connected else "L4 unavailable; use Capture now.")
    ...
    async def dismiss(self):
        async with self.lock:
            self.state.update(result=None, screenshot=None, busy=False, message="Dismissed · hold L4 to capture")
