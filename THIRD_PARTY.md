...
| Decky-Translator | https://github.com/cat-in-a-box/Decky-Translator | GPL-3.0; reference for Gamescope capture and the Steam composition hook in `src/Overlay.tsx` |
